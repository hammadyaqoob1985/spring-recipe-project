...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    //added annotation so that everything gets loaded in the same transaction
    @Transactional
    ...
    private List<Recipe> getRecipes() {
        ...
        guacamoleRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teapoonUom, guacamoleRecipe));
